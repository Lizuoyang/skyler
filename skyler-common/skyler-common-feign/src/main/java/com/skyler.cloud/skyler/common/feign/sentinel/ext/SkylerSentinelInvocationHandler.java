...
import com.skyler.cloud.skyler.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class SkylerSentinelInvocationHandler implements InvocationHandler {
	...
	SkylerSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			SkylerSentinelInvocationHandler other = (SkylerSentinelInvocationHandler) obj;

package com.skyler.cloud.skyler.common.job;

import com.skyler.cloud.skyler.common.job.properties.XxlExecutorProperties;
import com.skyler.cloud.skyler.common.job.properties.XxlJobProperties;
...
public class XxlJobAutoConfiguration {
	...
	public XxlJobSpringExecutor xxlJobSpringExecutor(XxlJobProperties xxlJobProperties, Environment environment,
		...
		// 如果配置为空则获取注册中心的服务列表 "http://skyler-xxl:9080/xxl-job-admin"

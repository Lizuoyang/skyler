...
public class SkylerResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public SkylerBearerTokenExtractor skylerBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new SkylerBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new SkylerCustomOpaqueTokenIntrospector(authorizationService);
	}
	...
	public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
		return new SkylerOAuthRequestInterceptor(tokenResolver);
	}

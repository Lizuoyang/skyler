...
public class SkylerCustomOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	...
	public OAuth2AuthenticatedPrincipal introspect(String token) {
		...
		try {
			...
			userDetails = optional.get().loadUserByUser((SkylerUser) tokenPrincipal);
		}
		...
		// 注入扩展属性,方便上下文获取客户端ID
		SkylerUser user = (SkylerUser) userDetails;

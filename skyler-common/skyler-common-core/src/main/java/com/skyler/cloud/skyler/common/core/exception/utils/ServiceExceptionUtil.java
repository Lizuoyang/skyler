package com.skyler.cloud.skyler.common.core.exception.utils;
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCodeEnum errorCode) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getCode(), errorCode.getMsg());
        return exception0(errorCode.getCode(), messagePattern);
    }

    public static ServiceException exception(ErrorCodeEnum errorCode, Object... params) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getCode(), errorCode.getMsg());

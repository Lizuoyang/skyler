...
import com.skyler.cloud.skyler.admin.api.feign.RemoteLogService;
import com.skyler.cloud.skyler.common.core.constant.SecurityConstants;
import com.skyler.cloud.skyler.common.core.jackson.SkylerJavaTimeModule;
...
public class SysLogListener implements InitializingBean {
	...
	private final SkylerLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		objectMapper.registerModule(new SkylerJavaTimeModule());
	}

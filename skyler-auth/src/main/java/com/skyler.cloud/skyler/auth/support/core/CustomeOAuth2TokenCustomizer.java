...
public class CustomeOAuth2TokenCustomizer implements OAuth2TokenCustomizer<OAuth2TokenClaimsContext> {
	...
	public void customize(OAuth2TokenClaimsContext context) {
		...
		SkylerUser skylerUser = (SkylerUser) context.getPrincipal().getPrincipal();
		claims.claim(SecurityConstants.DETAILS_USER, skylerUser);
		claims.claim(SecurityConstants.DETAILS_USER_ID, skylerUser.getId());
		claims.claim(SecurityConstants.USERNAME, skylerUser.getUsername());
	}

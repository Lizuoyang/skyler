...
import com.skyler.cloud.skyler.common.core.util.WebUtils;
 ...
 * @date 2022-06-04
 */
public class SkylerDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public SkylerDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, SkylerUserDetailsService> userDetailsServiceMap = SpringUtil
			.getBeansOfType(SkylerUserDetailsService.class);

		String finalClientId = clientId;
		Optional<SkylerUserDetailsService> optional = userDetailsServiceMap.values()
			.stream()

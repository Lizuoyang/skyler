	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
			<p class="navbar-text navbar-right">
				<a target="_blank" href="https://skyler4cloud.com">技术支持</a>
			</p>
			<p class="navbar-text navbar-right">
                <#if principalName=="anonymousUser">
					未登录
                <#else>
					<a target="_blank" href="https://skyler4cloud.com">${principalName}</a>
                </#if>
			</p>
		</div>
	</div>
...
<footer>
	<p>support by: skyler4cloud.com</p>
